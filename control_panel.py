...
class DisplayPanel(tk.LabelFrame):
    ...
    def __init__(self, master):
        ...
        self.hyper_queue_settings = DisplaySettings(master=self, row=6, text="super queue")
...
class ControlPanel(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.direction_panel.grid(row=4, column=0)

        self.display_panel = DisplayPanel(master=self)
        self.display_panel.grid(row=5, column=0)

        self.new_game_panel = NewGamePanel(master=self)
        self.new_game_panel.grid(row=6, column=0)
